...
<div style="display: none;" class="wpProQuiz_results">
		...
		echo wp_kses_post(
			SFWD_LMS::get_template(
				...
				array(
					...
					'message'      => '<p>' . sprintf( esc_html_x( '%1$s of %2$s questions answered correctly. You must get at least 70&#37; to continue.', 'placeholder: correct answer, question count', 'learndash' ), '<span class="wpProQuiz_correct_answer">0</span>', '<span>' . $question_count . '</span>' ) . '</p>',
	...
	<div class="ld-quiz-actions" style="margin: 10px 0px;">
		...
		echo '<a href="'. get_home_url() .'/user/" class="wpProQuiz_button quizmyacc grey-button">Go to My Courses</a>';
		...
		<?php if ( $quiz->isToplistActivated() && $quiz->getToplistDataShowIn() == WpProQuiz_Model_Quiz::QUIZ_TOPLIST_SHOW_IN_BUTTON ) { ?>
			<input class="wpProQuiz_button leadershipbutton" type="button" name="showToplist"
			value="<?php // phpcs:ignore Squiz.PHP.EmbeddedPhp.ContentBeforeOpen,Squiz.PHP.EmbeddedPhp.ContentAfterOpen
				echo wp_kses_post(
					SFWD_LMS::get_template(
						'learndash_quiz_messages',
