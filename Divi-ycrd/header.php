...
<html 
	...
	?>>
<head>
<meta name="facebook-domain-verification" content="rte8dcs93x9wtwqmi39jlu04ozzrjo" />	
...
<?php
	...
	$template_stylesheet_directory = get_stylesheet_directory_uri();
?>
...
?>
	...
	<?php if ( $et_top_info_defined && ! $et_slide_header || is_customize_preview() ) : ?>
		...
		<div id="top-header"<?php echo $et_top_info_defined ? '' : 'style="display: none;"'; ?>>
			...
			<?php
				$logo = $template_stylesheet_directory . '/images/logo_invert.svg';

				ob_start();
			?>
				<div class="logo_container">
					<span class="logo_helper"></span>
					<a class="logo_head" href="<?php echo esc_url( home_url( '/' ) ); ?>">
			...
			<?php if ( $et_contact_info_defined ) : ?>
				...
				<div class="newsletter_unit">
					<div class="newsletter_btn">
						<a class="" href="https://visitor.r20.constantcontact.com/manage/optin?v=001Cwy3-YNnJiCbynxdvD5zzFBR9gd5CF70zMJU0Qgti3NxJ_BxbagYDEehqhi3O76sFyVlOwOrmgQjHFl0l5T6GQqGPPmAkeL46qjH5ErwOlss42BHdlY0l5drZ7Cuuswi1cOTP5yOFO_sWkgjftFaJ6EyEqaQCKyz12oMS3Tu4Ng%3D">GET OUR NEWSLETTER</a>
					</div>
				</div>
	...
	<?php ob_start(); ?>
		<header id="main-header" data-height-onload="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>">
			<div class="container clearfix et_menu_container">
				...
				?>
				<div class="logo_container for_smalls">
					<span class="logo_helper"></span>
					<a class="logo_head" href="<?php echo esc_url( home_url( '/' ) ); ?>">
